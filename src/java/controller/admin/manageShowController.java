...
public class manageShowController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Show> shows = ShowDao.INS.getShowByCondition(title, date, order + " " + dimesion, page, 10);
        int count = ShowDao.INS.countShowByCondition(title, date);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int status = ShowDao.INS.updatetatusShow(showId);
        if (status != 1) {
