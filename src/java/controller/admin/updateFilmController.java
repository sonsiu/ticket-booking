...
public class updateFilmController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Film film = FilmDao.INS.getFilmByID(filmId);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int status = FilmDao.INS.updateFilm(genres, title, country, thumnail, premiere, actor, author, time, imgSlide, description, filmId);
        if (status != 1) {
