...
public class updateShowController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Show s = ShowDao.INS.findShow(showId);
        List<FilmSlide> films = ShowDao.INS.getAllFilmShow();
        List<Slot> slots = ShowDao.INS.getAllSlot();
        List<Room> rooms = ShowDao.INS.getAllRoom();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Show s = ShowDao.INS.findShow(slot, date);
        int updateShow = ShowDao.INS.updateShow(date, slot, film, room, showId);
        if (updateShow == 1) {
