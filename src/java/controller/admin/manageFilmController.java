...
public class manageFilmController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Film> film = FilmDao.INS.getFilmByCondition(title, date, genres, country, order + " " + dimesion, page, 10);
        List<Genres> gen = FilmDao.INS.getAllGenres();
        List<Country> coun = FilmDao.INS.getAllCountry();
        int total = FilmDao.INS.totalFilmByCondition(title, date, genres, country);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int status = FilmDao.INS.updateFilm(filmId);
        if (status != 1) {
